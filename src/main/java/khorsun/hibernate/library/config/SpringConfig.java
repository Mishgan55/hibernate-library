package khorsun.hibernate.library.config;
...
@Configuration
@ComponentScan("khorsun.hibernate.library")
@EnableWebMvc
@EnableJpaRepositories("khorsun.hibernate.library.repositories")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("khorsun.hibernate.library.models");
